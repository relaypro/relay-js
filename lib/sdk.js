...
class RelayEventAdapter extends events.EventEmitter {
  ...
  async sendReceive(type, payload, timeout=10000) {
    const id = makeId()
  ...
  async setLED(effect, args={}) {
    return this.sendReceive(`set_led`, { effect, args })
  }
  ...
  async sendNotification(type, text, target) {
    return this.sendReceive(`notification`, { type, text, target })
  }
  ...
  async terminate() {
    return this.sendReceive(`terminate`)
  }
}
